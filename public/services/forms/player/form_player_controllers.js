 ...
 */
"use strict";
var FormPlayerControllersModule;
(function (FormPlayerControllersModule) {
        ...
        function ($scope, $log, $uibModalInstance, $uibModal, items, FormPlayerService) {
            ...
            var Query = function () {
                ...
                FormPlayerService.Query(function (value) {
                    $scope.pages = value;
                    FormPlayerService.Over(function (hasnext) {
                        $scope.over = !hasnext;
                    });
                    FormPlayerService.Under(function (hasprev) {
                        $scope.under = !hasprev;
                    });
                    progress(false);
                }, error_handler);
...
})(FormPlayerControllersModule || (FormPlayerControllersModule = {}));
