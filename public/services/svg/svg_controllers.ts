...
namespace SVGControllersModule {

    let SVGControllers: angular.IModule = angular.module('SVGControllers', ['ui.bootstrap', 'ngAnimate', 'flow', 'ui.ace']);

//SVG

    SVGControllers.controller('SVGController', ["$scope", '$document', '$log', '$window', "$compile", '$uibModal', 'ShapeEdit', 'LayoutService',
    ...
    SVGControllers.controller('SVGDeleteConfirmController', ['$scope', '$uibModalInstance', 'items',
