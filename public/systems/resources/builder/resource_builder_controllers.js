 ...
 */
"use strict";
var ResourceBuilderControllersModule;
(function (ResourceBuilderControllersModule) {
        ...
        function ($scope, $log, $uibModalInstance, $uibModal, items, ResourceBuilderService) {
            ...
            var Query = function () {
                ...
                ResourceBuilderService.Query(function (result) {
                    ...
                    ResourceBuilderService.Over(function (hasnext) {
                        $scope.over = !hasnext;
                    });
                    ResourceBuilderService.Under(function (hasprev) {
                        $scope.under = !hasprev;
                    });
                    progress(false);
                }, error_handler);
...
})(ResourceBuilderControllersModule || (ResourceBuilderControllersModule = {}));
