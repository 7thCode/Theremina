 ...
 */
"use strict";
var ResourcePlayerControllersModule;
(function (ResourcePlayerControllersModule) {
        ...
        function ($scope, $log, $uibModalInstance, $uibModal, items, HtmlPlayerService) {
            ...
            var Query = function () {
                ...
                HtmlPlayerService.Query(function (value) {
                    $scope.pages = value;
                    HtmlPlayerService.Over(function (hasnext) {
                        $scope.over = !hasnext;
                    });
                    HtmlPlayerService.Under(function (hasprev) {
                        $scope.under = !hasprev;
                    });
                    progress(false);
                }, error_handler);
...
})(ResourcePlayerControllersModule || (ResourcePlayerControllersModule = {}));
